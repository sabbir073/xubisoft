                                                ...
                                                <SwiperSlider settings={slider} className="header-top-info-slider-wrap">
                                                    ...
                                                    <div className="item">
                                                        <InfoItem>
                                                            ...
                                                            <InfoContent>
                                                                <Heading {...infoHeading}>9:00AM - 6:00PM</Heading>
                                                                <Text {...infoText}>Saturday to Thursday</Text>
                                                            </InfoContent>
                                                        </InfoItem>
                                                    </div>
                                                    <div className="item">
                                                        <InfoItem>
                                                            ...
                                                            <InfoContent>
                                                                ...
                                                                <Text {...infoText}>+8801714-028710</Text>
                                                            </InfoContent>
                                                        </InfoItem>
                                                    </div>
                                                    <div className="item">
                                                        <InfoItem>
                                                            ...
                                                            <InfoContent>
                                                                <Heading {...infoHeading}>+880241090373</Heading>
                                                                <Text {...infoText}>Info@xubisoft.com</Text>
                                                            </InfoContent>
                                                        </InfoItem>
                                                    </div>
                                                </SwiperSlider>
